...
<div class="container">
    ...
    <h1 align="center" style="padding-top:20px; color:white">Dashboard</h1>
      ...
      <div class="detail-section">
        <a href="upcom_events.jsp"  type="button" class="btn btn-block btn-info" >More Info </a>
      </div>
    </div>
    <div class="dashbord dashbord-green">
      ...
      <div class="detail-section">
        <a href="old_events.jsp"  type="button" class="btn btn-block btn-info" >More Info </a>
      </div>
    </div>
    <div class="dashbord dashbord-orange">
      ...
      <div class="detail-section">
       <a href="curr_event.jsp"  type="button" class="btn btn-block btn-info" >More Info </a>
      </div>
    </div>
