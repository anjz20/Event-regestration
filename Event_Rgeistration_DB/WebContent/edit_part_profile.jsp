...
try{
	...
	PreparedStatement ps = c.prepareStatement("select * from person s,participant p where s.person_id = ? and s.person_id = p.person_id;");
	ps.setInt(1, id);
    ...
    <div class="login-form">
      <div class="sign-in-htm">
       ...
       <div class="group">
        ...
        <div class="group">
          <label for="phone" class="label">Category</label>
          <input class="category" type="radio" name="category" value="junior" checked> Junior &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <input class="category" type="radio" name="category" value="senior"> Senior
        </div>
        <div class="group">
       ...
       <div class="hr"></div>
        <div class="foot-lnk" style="color:white;">
          <a href="part_profile.jsp">Go to Profile page</a>
        </div>
  </div>
</div>
</form>
