                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="profile-img">
                            <img src="eventurous-logo-design.jpg" style="border:10px solid blue ; border-radius: 50%;">
                    ...
                    <div class="col-md-2">
                        <a href="update_event.jsp?event_id=<%=rs.getInt("event_id")%>"><input type="button" class="profile-edit-btn" name="btnAddMore" value="Update"/></a><br><br>
                    	<a href="delete_event.jsp?event_id=<%=rs.getInt("event_id")%>"><input type="button" class="profile-edit-btn" onclick="confirmBooking();" name="btnAddMore" value="Delete Event"/></a>
                    </div>
                </div>
                <div class="row">
                   <div class="col-md-4">
...
<%		session.setAttribute("event_id",0);
  		}
  	con.close();
 	} catch(Exception e){
