...
<nav class="navbar navbar-expand-lg bg-dark navbar-dark fixed-top" style="opacity:0.9;">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav ml-auto">
      <li class="nav-item" >
         <a class="nav-link" href="dashboard.jsp"><i class="fa fa-calendar" aria-hidden="true"></i>Dashboard</a>
      </li>
      <li class="nav-item" >
         <a class="nav-link" href="part_reg.jsp"><i class="fa fa-calendar" aria-hidden="true"></i>My Bookings</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="part_profile.jsp"><i class="fa fa-users" aria-hidden="true"></i>Edit profile</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="logout.jsp"><i class="fa fa-fw fa-user"></i>Logout</a>
      </li>    
    </ul>
  </div>  
  </div>
...
<div class="container" style="background-color:black; margin: 3%8%; margin-top:10%; padding:3%; opacity:0.7" >
         <h2 style="text-align:center; margin:20px; color:white;" >Events</h2>
