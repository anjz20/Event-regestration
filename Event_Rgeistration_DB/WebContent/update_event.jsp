...
try{
	...
	PreparedStatement ps = c.prepareStatement("select * from event_tab where event_id = ?");
	ps.setInt(1, id);
   ...
   <form action="UpdateEvent" method="post">
    <div class="login-form">
      <div class="sign-in-htm">
          ...
          <input name="e_name" type="text" class="input" value="<%=rs.getString("event_name")%>">
        </div>
        <div class="group">
          <label for="s_date" class="label">Start Date</label>
          <input name="s_date" type="date" class="input">
        </div>
       <div class="group">
          <label for="e_date" class="label">End Date</label>
          <input name="e_date" type="date" class="input">
        </div>
        <div class="group">
          <label for="category" class="label">Category <br><br>
          <span><input class="input" type="radio" name="category" value="Technical" style="margin-top:5px;" checked> Technical</span>
        ...
        <div class="group">
          ...
          <textarea name="desc" class="input" value="<%=rs.getString("description")%>"></textarea>
        </div>
        <div class="group">
          <label for="price" class="label">Price</label>
          <input name="price" type="number" class="input" value="<%=rs.getInt("price")%>">
        </div>
        <div class="group">
          <label for="capacity" class="label">Capacity</label>
          <input name="capacity" type="number" class="input" value="<%=rs.getInt("capacity")%>">
        </div>
